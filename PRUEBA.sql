...
CREATE TABLE IF NOT EXISTS `clientes` (
  ...
  `cliente_apellido` varchar(40) COLLATE utf8_spanish2_ci NOT NULL,
  `tipo_doc` varchar(50) COLLATE utf8_spanish2_ci NOT NULL,
  `cliente_numero_doc` varchar(11) COLLATE utf8_spanish2_ci NOT NULL,
  `cliente_telefono` varchar(11) COLLATE utf8_spanish2_ci NOT NULL,
  `municipio_id` int(10) unsigned NOT NULL,
  `cliente_direccion` varchar(150) COLLATE utf8_spanish2_ci NOT NULL,
  `cliente_email` varchar(80) COLLATE utf8_spanish2_ci NOT NULL,
  `created_at` date DEFAULT NULL,
  `updated_at` date DEFAULT NULL,
  `deleted_at` date DEFAULT NULL,
  PRIMARY KEY (`id_cliente`),
  UNIQUE KEY `Índice 3` (`cliente_numero_doc`),
  KEY `FK2_municipios` (`municipio_id`),
...
INSERT INTO `clientes` (`id_cliente`, `cliente_nombre`, `cliente_apellido`, `tipo_doc`, `cliente_numero_doc`, `cliente_telefono`, `municipio_id`, `cliente_direccion`, `cliente_email`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(2, 'hans peter', 'castellar del rio', '1', '1050957574', '3147550088', 1, 'assdfsdfsd', 'hans@gmail.com', '2019-06-30', '2019-07-30', '2019-07-31'),
	(3, 'juan carlos', 'noriega martinez', 'TARJETA DE IDENTIDAD', '105095472', '314548754', 1060, 'barrio sin nombre', 'hans@gmail.com', '2019-07-31', '2019-07-31', NULL),
	(4, 'santiago ', 'castellar garcia', '1', '4545445', '2212541', 433, 'brr los caballos', 'santi@gmail.com', '2019-07-31', NULL, '2019-08-01'),
	(5, 'iris ', 'del rio cabarcas', '1', '2548454', '1542154', 620, 'brr bolivar', 'iris@gmail.com', '2019-06-30', NULL, '2019-07-31'),
	(15, 'hans peter ', 'castellar ', 'TARJETA DE IDENTIDAD', '9854875454', '54545545', 251, 'ssdfsfsfd', 'el@gmail.com', '2019-08-01', NULL, '2019-08-01'),
	(17, 'hans peter ', 'castellar ', 'TARJETA DE IDENTIDAD', '12345', '54545545', 251, 'ssdfsfsfd', 'el@gmail.com', '2019-08-01', NULL, NULL),
	(19, 'hans peter ', 'castellar ', 'TARJETA DE IDENTIDAD', '12', '54545545', 251, 'ssdfsfsfd', 'el@gmail.com', '2019-08-01', NULL, NULL),
